...
const SidebarDashboard: React.FC<SidebarProps> = ({ activeSection, setActiveSection }) => {
  ...
  return (
    <aside className="w-20 md:w-64 bg-gradient-to-b from-pink-50 to-white shadow-xl border-r border-gray-200 h-screen transition-all duration-300 flex flex-col justify-between">
      <div>
        <div className="p-4 border-b border-gray-100">
          <h2 className="hidden md:block text-xl font-poppins font-bold text-pink-600">Flores E-commerce</h2>
